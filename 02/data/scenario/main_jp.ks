...
<p>面積は実に1万平方メートル以上。ワールドカップのサッカーコート2枚分程度にあたり、代表作のモチーフとなった<span class="html_red">睡蓮</span>を始め、世界中から集められた数千種類の植物が植えられていました。もちろん一人で手入れはできないので、庭師を数人雇っていたとか。</p>
<p>広大な庭に咲き誇る花や輝く池は、モネの重要なインスピレーションの源となったのです。</p>
[endhtml]
